...
from .errors import NeptuneError, NeptuneSyntaxError


class NeptuneInterpreter:
    """Execute ``.nep`` scripts."""
    ...
    def run_line(self, line: str) -> None:
        ...
        try:
            ...
            raise NeptuneSyntaxError(str(e)) from e
        ...
        with open(path, encoding="utf-8") as f:
            for lineno, raw in enumerate(f, start=1):
                ...
                try:
                    ...
                    raise NeptuneError(f"{path}:{lineno}: {e}") from e
